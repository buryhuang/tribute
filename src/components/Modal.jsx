    ...
    >
      ...
      >
        ...
        <div className="flex flex-row items-center sm:justify-between gap-5 sm:gap-3 text-gray-700 dark:text-gray-200 px-2 sm:px-4 py-2 sm:py-4 border-b-2 bg-white border-gray-200 dark:border-gray-800">
          ...
          <span
            className={`${
              isCloseable ? "inline-block sm:hidden" : "hidden"
          ...
          <span
            className={`${
              isCloseable ? "hidden sm:inline-block" : "hidden"
            } cursor-pointer transition hover:scale-125`}
            onClick={onClose}
          >
            <svg
        ...
        <div
          ...
          } flex-col justify-center items-center py-10`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="icon icon-tabler icon-tabler-loader text-gray-700 dark:text-white animation animate-spin w-10 h-10"
            viewBox="0 0 24 24"
            strokeWidth="1.5"
            stroke="currentColor"
            fill="none"
